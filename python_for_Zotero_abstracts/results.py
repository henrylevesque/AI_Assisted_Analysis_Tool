...
initial_user_content = 'I am going to give you the text of an abstract. Please identify the results from the abstract. Do not tell me anything else. If you tell me anything besides the results used in the abstract you will not be helpful. The abstract text is:'
...
# Output file path
output_file_name = os.path.splitext(file_name)[0] + '_results_ai_responses.xlsx'
